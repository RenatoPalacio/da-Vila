...
class Encomendas extends StatefulWidget {
  String _idUsuario;
  Encomendas(this._idUsuario);
  @override
  _EncomendasState createState() => _EncomendasState();
}

class _EncomendasState extends State<Encomendas> {
  String _idUsuario;
  List _encomendas = List();
  bool _semEncomendas = false;
  String _entrega = "";
                ...
                case ConnectionState.active:
                  case ConnectionState.done:
                    ...
                    for (DocumentSnapshot documentSnapshot in querySnapshot.documents){
                      ...
                      encomenda.entrega = documentSnapshot["entrega"];
                      print("entrega primeira: ${encomenda.entrega}");
                    ...
                    return Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, indice){
                              ...
                              _entrega = _encomendas[indice]["Entrega"];
                              print("entrega segunda: $_entrega");
                              if(_entrega == null){
                                _entrega = "Entrega/Retirada: combinar com o vendedor";} else if (_entrega != "Retirada"){
                                _entrega = "Entrega";
                              };
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Padding(
                                                      padding: EdgeInsets.fromLTRB(0, 6, 10, 10),
                                                      child: Row(
                                                        children: [
                                                          Text(
                                                            _entrega,
