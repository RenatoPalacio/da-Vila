...
class LerDetalhesPedido extends StatefulWidget {
  String _url;
  String _comprador;
  String _data;
  String _status;
  ...
  String _idLoja;
  String _idPedido;
  LerDetalhesPedido(this._url, this._comprador, this._data, this. _status, this._idUsuario, this._idLoja, this._idPedido);
  @override
  _LerDetalhesPedidoState createState() => _LerDetalhesPedidoState();
}

class _LerDetalhesPedidoState extends State<LerDetalhesPedido> {
  String _comprador;
  String _idUsuario;
  String _idLoja;
  String _idPedido;
  ...
  _conversarCom(){
    ...
    Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => trocaMensagem(_url, _comprador, _idUsuario, _idComprador, _idLoja, _idLojaAlterado, _idUsuario)));
  }
  ...
  _removeDelivery() async {
    ...
    _primeiravez = true;
    setState(() {
      _deliveryAgendado = false;
      _temEntregador = false;
    });
  }
  ...
  void initState() {
    ...
    print("idPedido: ${_idPedido + "_" + _nLoja}");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Encomenda de $_comprador"),
      ),
      body: SafeArea(
          child: Container(
              width: c_width,
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  DropdownButton<String>(
                                    ...
                                    items: <String>['Realizado', 'Em preparação', 'Enviar', 'Entregue', 'Cancelado']
